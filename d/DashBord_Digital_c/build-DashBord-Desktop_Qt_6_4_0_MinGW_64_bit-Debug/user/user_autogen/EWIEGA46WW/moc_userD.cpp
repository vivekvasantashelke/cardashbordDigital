/****************************************************************************
** Meta object code from reading C++ file 'userD.h'
**
...
#error "The header file 'userD.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_user_t qt_meta_stringdata_user = {
    {
        ...
        QT_MOC_LITERAL(5, 14),  // "addinDBfromqml"
        QT_MOC_LITERAL(20, 0)   // ""
    },
    "user",
    "addinDBfromqml",
...
void user::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->addinDBfromqml((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        default: ;
        }
    }
}
